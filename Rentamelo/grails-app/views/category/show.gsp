            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="category.parent.label" default="Parent" /></td>
                            
                            <td valign="top" class="value"><g:link controller="category" action="show" id="${categoryInstance?.parent?.id}">${categoryInstance?.parent?.encodeAsHTML()}</g:link></td>
                            
                        </tr>
                    
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="category.children.label" default="Children" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="category.items.label" default="Items" /></td>
